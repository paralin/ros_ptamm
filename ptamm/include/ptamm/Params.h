...
#include <ptamm/PtamParamsConfig.h>
#include <string.h>
#include <ros/ros.h>
...
typedef dynamic_reconfigure::Server<ptamm::PtamParamsConfig> PtamParamsReconfigureServer;
typedef ptamm::PtamParamsConfig VarParams;
...
private:
  ptamm::PtamParamsConfig mVarParams;
  FixParams mFixParams;

  PtamParamsReconfigureServer *mpPtamParamsReconfigureServer;

  void ptammParamsConfig(ptamm::PtamParamsConfig & config, uint32_t level){
    mVarParams = config;
  };
  ...
  PtamParameters()
  {
    ...
    PtamParamsReconfigureServer::CallbackType PtamParamCall = boost::bind(&PtamParameters::ptammParamsConfig, this, _1, _2);
...
public:
  static const ptamm::PtamParamsConfig& varparams(){
    if(!inst_){
