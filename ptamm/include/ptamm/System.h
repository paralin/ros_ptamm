...
//  bool mbDone;
  ...
  bool pointcloudservice(ptamm_com::PointCloudRequest & req, ptamm_com::PointCloudResponse & resp);
  bool keyframesservice(ptamm_com::KeyFrame_srvRequest & req, ptamm_com::KeyFrame_srvResponse & resp);
