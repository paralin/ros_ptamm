#include <ros/ros.h>
#include <ptamm_com/PointCloud.h>
#include <ptamm_com/KeyFrame_srv.h>
#include <ptamm_com/KeyFrame_msg.h>
#include <sensor_msgs/PointCloud2.h>
#include <ptamm/PTAMVisualizerParamsConfig.h>
#include <dynamic_reconfigure/server.h>
#include <visualization_msgs/Marker.h>
#include <ptamm/AxesArray.h>
...
typedef dynamic_reconfigure::Server<ptamm::PTAMVisualizerParamsConfig> ReconfigureServer;
...
void Config(ptamm::PTAMVisualizerParamsConfig &config, uint32_t level);
...
{
  ros::init(argc, argv, "ptamm_visualizer");
  ros::NodeHandle n;
  ros::ServiceClient PC2client = n.serviceClient<ptamm_com::PointCloud>("vslam/pointcloud");
  ros::ServiceClient KFclient = n.serviceClient<ptamm_com::KeyFrame_srv>("vslam/keyframes");
  ros::Publisher pub_cloud = n.advertise<sensor_msgs::PointCloud2> ("vslam/pc2", 1);
  ros::Publisher pub_kfs = n.advertise<ptamm_com::KeyFrame_msg> ("vslam/kfs",1);
  ...
  ptamm_com::PointCloud srv_pc2;
  ptamm_com::KeyFrame_srv srv_kfs;
